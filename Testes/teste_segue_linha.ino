...
void segue_linha(){
  ...
  if(leitura_esq > MED_ESQ){
    leitura_esq = PRETO;
    Serial.println("Esquerda ta no preto");
  }else{
    leitura_esq = BRANCO;
    Serial.println("Esquerda ta no branco");
  }

  if(leitura_dir > MED_DIR){
    leitura_dir = PRETO;
    Serial.println("Direita ta no preto");
  }else{
    leitura_dir = BRANCO;
    Serial.println("Direita ta no branco");
  }
  ...
  } else if(leitura_dir > leitura_esq)
  {
    ...
    while(leitura_dir > leitura_esq){
      ...
      leitura_esq = media_vetor(1);
      leitura_dir = media_vetor(0);
      Serial.println("Bora pra DIREITA");
      // movimento(frente);
      // analogWrite(MD, 40);
      // analogWrite(ME, 35);
      // delay(200);
  ...
  } else if(leitura_esq > leitura_dir)
  {
    ...
    while(leitura_esq > leitura_dir){
      ...
      leitura_esq = media_vetor(1);
      leitura_dir = media_vetor(0);
      Serial.println("Bora pra ESQUERDA");
      // movimento(frente);
      // analogWrite(MD, 40);
      // analogWrite(ME, 35);
      // delay(200);
